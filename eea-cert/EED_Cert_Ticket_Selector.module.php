...
/**
 * This file contains the module for the EE Certificates addon ticket selector integration
 *
 * @since 1.0.0
...
/**
 *
 * EED_WP_Users_Ticket_Selector module.  Takes care of certificates integration with ticket selector.
 *
 * @since 1.0.0
 *
 * @package        EE Certificates
 ...
 * ------------------------------------------------------------------------
 */
class EED_Cert_Ticket_Selector  extends EED_Module {

    public static function set_hooks() {
        add_filter( 'FHEE__ticket_selector_chart_template__do_ticket_inside_row', array( 'EED_Cert_Ticket_Selector', 'maybe_restrict_ticket_option_by_cap' ), 10, 9 );
    ...
    public static function maybe_restrict_ticket_option_by_cap( $return_value, EE_Ticket $tkt, $max, $min, $required_ticket_sold_out, $ticket_price, $ticket_bundle, $tkt_status, $status_class ) {
        ...
        $inner_message = apply_filters( 'FHEE__EED_Cert_Ticket_Selector__maybe_restrict_ticket_option_by_cap__no_access_msg',
        ...
        $full_html_content = apply_filters( 'FHEE__EED_Cert_Ticket_Selector__maybe_restrict_ticket_option_by_cap__no_access_msg_html', $full_html_content, $inner_message, $tkt, $ticket_price, $tkt_status );
        return $full_html_content;
    }

} //end class EED_Cert_Ticket_Selector
