<tr id="advanced-dtt-edit-row-<?php echo $dtt_row; ?>" class="advanced-dtt-edit-row">
	<td colspan="6">
		<section id="edit-event-datetime-tickets-<?php echo $dtt_row; ?>" class="datetime-tickets-edit"<?php echo $show_tickets_row; ?>>
			...
			<h4 class="ce-credits-heading"><?php esc_html_e('Credits and Certificate Options', 'event_espresso'); ?></h4>
			<div class="cert-option-container">
				<span class="dtt-cert-active">Event has CE credits?<input type="checkbox" name="datetime_cert[<?php echo $dtt_row; ?>]" class="datetime-cert-checkbox" value="1"<?php echo $datetime_cert_checked; ?>></span>
				<span class="dtt-cert-credits">CE credits earned for event<input type="text" name="ce_credits" class="ee-small-text-inp cert-ce-credits-qty ee-numeric" size="1"></span>
			</div>
