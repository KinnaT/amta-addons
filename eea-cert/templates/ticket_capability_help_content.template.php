...
<p>
    <?php _e( 'This field is introduced as a feature that is part of the Certificates addon.  It enables you to set restrictions on who can purchase the ticket option.  This is an excellent way to create "Member Only" type discounts to people visiting your site.', 'event_espresso' ); ?>
</p>
