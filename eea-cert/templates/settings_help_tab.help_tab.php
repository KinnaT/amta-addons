<p><strong><?php esc_attr_e( 'Certificates Settings', 'event_espresso'); ?></strong></p>
<p>
    <?php esc_attr_e( 'This page shows options for the Certificates add-on', 'event_espresso' ); ?>
</p>
