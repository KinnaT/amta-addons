 ...
 *
 */
class EE_DMS_Cert_1_0_0 extends EE_Data_Migration_Script_Base{

    public function __construct() {
        $this->_pretty_name = __("Data Migration to Cert 1.0.0", "event_espresso");
    ...
    public function schema_changes_before_migration() {
        $this->_table_is_new_in_this_version('esp_cert_attendee_meta', '
            CATT_ID int(10) unsigned NOT NULL AUTO_INCREMENT,
            ATT_ID int(10) unsigned NOT NULL,
            DTT_ID int(10) unsigned NOT NULL,
            ATT_ce int(10) unsigned NOT NULL,
            PRIMARY KEY  (CATT_ID)'
                );
        $this->_table_is_new_in_this_version('esp_cert_datetime_meta', '
...
// End of file EE_DMS_Cert_0_0_1.dms.php
