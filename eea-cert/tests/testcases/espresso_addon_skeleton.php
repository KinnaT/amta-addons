...
class espresso_promotions_tests extends EE_UnitTestCase {
     ...
     * @since 0.0.1.dev.002
     */
    function test_loading_cert() {
        $this->assertEquals( has_action('AHEE__EE_System__load_espresso_addons', 'load_espresso_cert'), 10 );
        $this->assertTrue( class_exists( 'EE_Cert' ) );
    }
}
