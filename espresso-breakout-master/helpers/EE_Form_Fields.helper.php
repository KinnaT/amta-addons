...
class EE_Form_Fields {
     ...
     *     @static     @access public     @param    array $input_vars - array of input field details
     *     format:
    ...
    // Simply return sthe HTML for a hidden input of the given name and value. @param string $name @param string $value @return string HTML
