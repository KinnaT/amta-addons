...
class EE_Breakouts_Admin {
    // holds array of $_REQUEST items. @var array
    private $req_data;
    // holds the slug for the settings page @var string
    private $_wp_slug;
    // holds the current settings (if present and if not we set defaults) @var array
    private $_settings;
    ...
    // all stuff for on page load. Nothing here at the moment, but leaving this for future if needed. @return void
    ...
    // displays the options page  @return string html for page
