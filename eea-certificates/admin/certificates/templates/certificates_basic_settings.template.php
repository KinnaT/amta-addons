    ...
    <table class="form-table">
        <tbody>
            <tr>
                ...
                <td>
                    <?php echo EEH_Form_Fields::select( __('Enable Certificates?', 'event_espresso'), 0, $yes_no_values, 'enable_certificates', 'enable_certificates' ); ?><br/>
                </td>
            </tr>
            <tr>
                <th><?php _e("Reset Certificates Settings?", 'event_espresso');?></th>
                <td>
                    <?php echo EEH_Form_Fields::select( __('Reset Certificates Settings?', 'event_espresso'), 0, $yes_no_values, 'reset_certificates', 'reset_certificates' ); ?><br/>
