 ...
 *
 */
class EE_DMS_Certificates_1_0_0 extends EE_Data_Migration_Script_Base{

    public function __construct() {
        $this->_pretty_name = __("Data Migration to Certificates 1.0.0", "event_espresso");
    ...
    public function can_migrate_from_version($current_database_state_of) {
        ...
        if( isset( $current_database_state_of[ $this->slug() ] ) ) {
            if( version_compare( '1.0.0', $current_database_state_of[ $this->slug() ], '>')) {
    ...
    public function schema_changes_before_migration() {
        $this->_table_is_new_in_this_version('esp_certificates_attendee_meta', '
            NATT_ID int(10) unsigned NOT NULL AUTO_INCREMENT,
            ATT_ID int(10) unsigned NOT NULL,
            ATT_ce int(10) unsigned NOT NULL,
            PRIMARY KEY  (NATT_ID)'
                );
        $this->_table_is_new_in_this_version('esp_certificates_event_meta', '
            CE_ID int(10) unsigned NOT NULL AUTO_INCREMENT,
            DTT_ID int(10) unsigned NOT NULL,
            DTT_ce int(10) unsigned NOT NULL,
            ATT_ID int(10) unsigned NOT NULL,
            PRIMARY KEY  (CE_ID)'
                );
    }
...
// End of file EE_DMS_Certificates_0_0_1.dms.php
