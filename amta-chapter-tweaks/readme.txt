...
== Description ==
Stuff that allows me to clone these sites and have it still work with the heaviest, most obtrusive custom theme I\'ve ever encountered.  Creating this small group of files should help me pare down the bloat as I unhook functionality from the rigidity of the theme and move it to swappable and well-supported plugins.
...
A senseless determination to get these tiny, unloved sites to work well.  Pride.
